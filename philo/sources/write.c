...
/*   Updated: 2024/03/18 15:56:31 by jgasparo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	write_status(char *str, t_philo *philo)
{
	...
	if (philo->arg->run)
		printf(GREEN "%-10zu" RESET ORANGE "%-10d" RESET YELLOW"%s" RESET "run : %d\n", \
				get_current_time(philo->arg->start_simulation), philo->id, str, philo->arg->run);
